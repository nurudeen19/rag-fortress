        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center">
            ...
            <div class="flex items-center space-x-3">
              <img src="/logo.png" alt="RAG Fortress Logo" class="w-8 h-8 rounded-lg">
...
const svgPaths = {
  ...
  knowledge: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C6.5 6.253 2 10.998 2 17s4.5 10.747 10 10.747c5.5 0 10-4.998 10-10.747S17.5 6.253 12 6.253z" />',
  ...
  alerts: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4v2m6-6v12a2 2 0 01-2 2H8a2 2 0 01-2-2V9m12-7l-1.414 1.414M3.414 3.414L2 4.828M19 3h-1m-16 0h-1m15 16h1m-16 0h1" />',
